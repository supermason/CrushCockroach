package com.mason.crushcockroach.ui 
{
	...
	public class HUD extends GameSprite 
	{
		...
		override protected function drawScreen():void 
		{
			...
			_txtLivesLbl = new TextField(150, 20, "L I V E S", _font.fontName, _font.fontSize, 0xffffff);
			...
			_txtKillCountLbl = new TextField(150, 20, "K I L L", _font.fontName, _font.fontSize, 0xffffff);
			...
			_txtDurationLbl = new TextField(150, 20, "D U R A T I O N", _font.fontName, _font.fontSize, 0xffffff);
